...
matches_data = {
    "Vs Los Angeles": [
        ("DUEL OFENSIVO WON", 65.15, 8.42, "videos/D4 - LA.mp4"),
        ("DUEL OFENSIVO WON", 84.27, 13.57, "videos/D2 - LA.mp4"),
        ("DUEL OFENSIVO LOST", 71.64, 25.04, "videos/D1 - LA.mp4"),
        ("DUEL OFENSIVO LOST", 95.08, 17.39, "videos/D3 - LA.mp4"),
        ("DUEL OFENSIVO LOST", 103.22, 4.26, "videos/D5 - LA.mp4"),
    ],
    "Vs Sockers": [
        ("FOULED", 106.88, 2.10, "videos/D5 - SK.mp4"),
        ("DUEL OFENSIVO WON", 111.20, 7.75, "videos/D4 - SK.mp4"),
        ("DUEL OFENSIVO WON", 105.55, 14.57, "videos/D3 - SK.mp4"),
        ("DUEL OFENSIVO WON", 48.20, 13.07, "videos/D1 - SK.mp4"),
        ("DUEL OFENSIVO LOST", 39.22, 17.56, "videos/D2 - SK.mp4"),
    ],
    "Vs Slavia Praha": [
        ("DUEL OFENSIVO WON", 118.35, 21.22, "videos/D1 - SP.mp4"),
        ("FOULED", 95.08, 10.41, "videos/D9 - SP.mp4"),
        ("DUEL OFENSIVO WON", 87.59, 5.09, "videos/D6 - SP.mp4"),
        ("DUEL OFENSIVO WON", 84.44, 8.75, "videos/D10 - SP.mp4"),
        ("FOULED", 77.29, 11.41, "videos/D5 - SP.mp4"),
        ("DUEL OFENSIVO WON", 64.32, 6.42, "videos/D4 - SP.mp4"),
        ("FOULED", 48.03, 12.74, "videos/D2 - SP.mp4"),
        ("DUEL OFENSIVO LOST", 102.06, 19.55, "videos/D8 - SP.mp4"),
        ("DUEL OFENSIVO LOST", 113.03, 16.73, "videos/D7 - SP.mp4"),
        ("DUEL OFENSIVO LOST", 105.71, 21.71, "videos/D3 - SP.mp4"),
    ],
}
